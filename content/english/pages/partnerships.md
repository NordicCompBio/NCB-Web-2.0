...
meta_title: ""
# meta description
description: "Information about partnerships and sponsors of Nordic Computational Biology (NCB) across the Nordic region."
# save as draft
draft: false
---
...
<style>
  ...
  .partner-sponsor-title,
  .partner-sponsor-text {
    color: #ffffff;
  }
  ...
  .dark .partner-main h2,
  .dark .partner-main h4,
  .dark .partner-main p {
    color: #f3f4f6;
  }
  ...
  .dark .partner-collab-grid img,
  .dark .partner-main-inner img {
    background: #d1d5db;
    padding: 0.25rem;
...
<div class="partnerships-shell">
<!-- Sponsor -->
<div class="partner-sponsor-box">
    <h2 class="partner-sponsor-title" style="font-weight: bold; margin: 0;">
      NCB Sponsors
    </h2>
    <p class="partner-sponsor-text" style="margin-top: 10px; font-size: 16px;">
    ...
    <a class="partner-sponsor-cta" href="https://docs.google.com/forms/d/e/1FAIpQLSc8Or_RBCspmsly41JN_qkUpS7tb2DeB9UOR9Ci0MzTMZ9Kaw/viewform" target="_blank">
